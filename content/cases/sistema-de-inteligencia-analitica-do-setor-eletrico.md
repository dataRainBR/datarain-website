...
Em uma cooperação inédita, as duas instituições se uniram para criar o **Sistema de Inteligência Analítica do Setor Elétrico**, uma plataforma capaz de consolidar, processar e disponibilizar dados estratégicos sobre o mercado de energia no país.
...
A **dataRain** foi responsável por provisionar e configurar toda a infraestrutura na nuvem **AWS**, garantindo que os ambientes de homologação e produção estivessem prontos dentro do cronograma exigido pelo projeto. A arquitetura foi desenhada para oferecer segurança, performance e facilidade de gerenciamento, utilizando serviços gerenciados da AWS que reduzem a complexidade operacional.

## Componentes AWS

- **Amazon EC2** — instâncias de computação para processamento analítico
- **Amazon EBS** — armazenamento em bloco de alta performance
- **Amazon S3** — armazenamento de objetos para datasets e backups
- **Amazon Route 53** — gerenciamento de DNS e roteamento de tráfego
- **Amazon VPC** — isolamento de rede e controle de acesso

## Serviços Agregados

- Setup e configuração dos ambientes
- Consultoria em arquitetura de nuvem
- Gerenciamento de ambiente
- Operação contínua (**DevOps**)

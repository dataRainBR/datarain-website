              ...
              {cases.map((caseStudy, index) => (
                <CarouselItem key={caseStudy.id} className="pl-4 md:basis-1/2 lg:basis-1/3">
                  ...
                  <div className="group relative h-full">
                    ...
                    <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl overflow-hidden shadow-2xl border border-white/20 h-full transition-all duration-300 group-hover:border-white/40 group-hover:shadow-white/10">
                      {/* Padrão decorativo interno */}
                      <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-white/10 to-transparent rounded-bl-full"></div>
                      <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-accent/20 to-transparent rounded-tr-full"></div>
                      ...
                      <div className="relative z-10 p-6 sm:p-8 min-h-[320px] flex flex-col justify-between">
                        <div>
                          ...
                          <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-3 leading-tight text-white group-hover:text-accent transition-colors duration-300">
                            {caseStudy.title}
                          </h3>
                        ...
                        <button 
                          ...
                          className="mt-6 text-white font-semibold text-sm sm:text-base inline-flex items-center gap-2 transition-all duration-300 bg-white/10 hover:bg-white/20 px-5 py-2.5 rounded-xl backdrop-blur-sm border border-white/10 hover:border-white/30 self-start group-hover:translate-x-1"
                        >
                          <span>Leia o case</span>

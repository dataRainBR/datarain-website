...
import { Home, Palette, Building2, Users, Globe, Sparkles, ChevronLeft, ChevronRight } from 'lucide-react';
...
const steps: JourneyStep[] = [
  { id: 'challenge', icon: Home, title: 'Imóveis de luxo pedem tecnologia à altura', narrative: 'A VNC Private Homes, especializada em imóveis de alto padrão, precisava se modernizar tecnologicamente sem perder o toque personalizado que seus clientes de elite esperam.', before: 'Gestão de portfólio de luxo sem plataforma centralizada', after: 'Soluções digitais que combinam sofisticação visual com eficiência operacional', color: '#2563eb' },
  { id: 'branding', icon: Palette, title: 'Comunicação visual sofisticada', narrative: 'Evolução dos elementos de marca — modernização de aplicações, paletas e tipografias. Brochuras, portfólios digitais e apresentações que destacam os imóveis de luxo.', before: 'Identidade visual que não refletia o posicionamento de luxo contemporâneo', after: 'Marca renovada com elegância e sofisticação em todos os materiais', highlight: 'Luxo contemporâneo', color: '#7c3aed' },
  { id: 'platform', icon: Building2, title: 'Sistema de gestão de imóveis', narrative: 'Plataforma centralizada para gerenciar o portfólio completo da captação à venda, com atualização em tempo real de status e informações.', before: 'Portfólio gerenciado sem plataforma centralizada, da captação à venda', after: 'Gestão completa do ciclo de vida do imóvel em tempo real', color: '#d97706' },
  { id: 'crm', icon: Users, title: 'CRM personalizado para alto padrão', narrative: 'Gestão detalhada dos relacionamentos do primeiro contato ao fechamento, com atendimento personalizado e eficaz para clientes de elite.', before: 'Sem CRM dedicado ao perfil de clientes de alto padrão', after: 'CRM sob medida com histórico completo e atendimento personalizado', color: '#dc2626' },
  { id: 'portal', icon: Globe, title: 'Portal exclusivo e site imersivo', narrative: 'Site redesenhado com experiência digital imersiva e portal onde clientes acessam informações detalhadas, agendam visitas e recebem recomendações personalizadas.', before: 'Site sem experiência imersiva compatível com o posicionamento da marca', after: 'Presença digital elegante com portal exclusivo para clientes', highlight: 'Experiência digital imersiva', color: '#0d9488' },
  { id: 'results', icon: Sparkles, title: 'Marca fortalecida e produtividade elevada', narrative: 'Plataformas de gestão otimizaram processos, reduziram tarefas administrativas e reforçaram a imagem de exclusividade e sofisticação da VNC.', before: 'Tarefas administrativas consumindo tempo do atendimento personalizado', after: 'Produtividade elevada e marca fortalecida no mercado de luxo', highlight: 'Exclusividade digital', color: '#059669' },
];

export const VNCDemo: React.FC = () => {
    ...
    <div className="w-full max-w-4xl mx-auto my-8">
      <div className="relative rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-lg">
        ...
        <div className="relative p-5 md:p-8 space-y-6">
          ...
          {isLast && <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="text-center py-4 rounded-xl bg-emerald-50 border border-emerald-200"><p className="text-sm text-emerald-700 font-medium">A VNC Private Homes elevou sua operação ao nível digital que seus clientes de luxo merecem.</p><p className="text-xs text-slate-500 mt-1">Marca sofisticada, gestão centralizada e experiência exclusiva.</p></motion.div>}
        </div>
      </div>
    </div>
  );

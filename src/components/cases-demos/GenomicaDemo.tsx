...
import {
  Building2, FlaskConical, Zap, Microscope, Pill, HeartPulse,
...
const steps: JourneyStep[] = [
  {
    id: 'arrival',
    icon: Building2,
    title: 'Paciente chega ao HC',
    narrative: 'Um paciente com histórico familiar de doenças cardíacas chega ao Hospital das Clínicas. A equipe médica precisa entender se há predisposição genética.',
    before: 'Exames genéticos limitados, semanas de espera, análise manual fragmentada',
    after: 'Solicitação de análise genômica completa, integrada ao prontuário digital',
    color: '#d97706',
  },
  {
    id: 'collection',
    icon: FlaskConical,
    title: 'Coleta e sequenciamento',
    narrative: 'Uma amostra de sangue é coletada e enviada para sequenciamento. O genoma do paciente será lido e digitalizado.',
    before: 'Dados armazenados em servidores locais sem capacidade de escala — gargalo constante',
    after: 'Dados ingeridos automaticamente no Data Lake na nuvem, com 367 TB já organizados',
    color: '#db2777',
  },
  {
    id: 'analysis',
    icon: Zap,
    title: 'Análise em escala',
    narrative: 'O perfil genético do paciente é processado por pipelines de bioinformática, cruzando bilhões de dados em busca de variantes relevantes.',
    before: 'Processamento em servidores locais — lento, caro, sem escalabilidade',
    after: 'Processamento 3x mais rápido na nuvem, com redução de 40% nos custos',
    highlight: '3x mais rápido · -40% custo',
    color: '#2563eb',
  },
  {
    id: 'discovery',
    icon: Microscope,
    title: 'Descoberta clínica',
    narrative: 'A análise identifica uma variante genética associada a risco cardiovascular elevado. O sistema gera uma recomendação personalizada.',
    before: 'Dados fragmentados impediam cruzamento entre genômica e histórico clínico',
    after: 'Data Lake integrado permite análise cruzada — genômica + prontuário + pesquisa',
    highlight: 'Risco cardiovascular +23%',
    color: '#7c3aed',
  },
  {
    id: 'treatment',
    ...
    narrative: 'O médico recebe a recomendação: tratamento preventivo com ácido fólico e acompanhamento cardiológico. O paciente entra em protocolo personalizado.',
    before: 'Tratamento genérico, sem considerar perfil genético individual',
    after: 'Medicina de precisão — tratamento baseado no DNA do paciente',
    color: '#0d9488',
  },
  {
    id: 'outcome',
    icon: HeartPulse,
    title: 'Desfecho',
    narrative: 'Paciente em acompanhamento preventivo personalizado. Evento cardiovascular evitado. A pesquisa alimenta o banco de dados para futuros pacientes.',
    before: 'Diagnóstico tardio, tratamento reativo, dados perdidos após o caso',
    after: 'Prevenção ativa, dados contribuem para pesquisa contínua, ciclo virtuoso',
    highlight: 'Evento cardiovascular evitado',
    color: '#059669',
  },
];
...
export const GenomicaDemo: React.FC = () => {
      ...
      <div className="relative rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-lg">
        ...
        <div className="relative p-5 md:p-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm font-semibold text-slate-700">Jornada do Paciente — HCFMUSP × dataRain</span>
          ...
          {isLast && (
            ...
            >
              <p className="text-sm text-emerald-700 font-medium">
                A dataRain construiu a infraestrutura que torna isso possível.
              </p>
              <p className="text-xs text-slate-500 mt-1">De dados brutos a vidas transformadas.</p>
            </motion.div>
          )}
        </div>
      </div>

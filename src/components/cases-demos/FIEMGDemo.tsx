...
import {
  Factory, Database, Brain, BarChart3, GitBranch, Rocket,
...
const steps: JourneyStep[] = [
  { id: 'challenge', icon: Factory, title: 'Dados industriais sem inteligência', narrative: 'A FIEMG precisava transformar dados brutos de SQL Server on-premises em insights acionáveis para a indústria mineira, com pipeline completo de analytics e ML.', before: 'Dados em SQL Server on-premises sem análise avançada', after: 'Pipeline completo de Data Analytics e ML na AWS', color: '#2563eb' },
  { id: 'datalake', icon: Database, title: 'Data Lake em 4 camadas', narrative: 'Ingestão via Airbyte conectando SQL Server ao S3, com Data Lake em 4 camadas (Transição, Crua, Tratada, Processada) e Glue Data Quality para validação automatizada.', before: 'Dados sem organização, qualidade ou governança', after: 'Data Lake com 4 camadas e validação automatizada de qualidade', color: '#7c3aed' },
  { id: 'ml', icon: Brain, title: 'Machine Learning e mineração', narrative: 'SageMaker com Feature Store e Batch Transform para análise exploratória, Dynamic Factor Analysis (DFA), PCA, clusterização e modelos de predição.', before: 'Análises manuais sem capacidade preditiva', after: 'Modelos de ML para predição e clusterização com SageMaker', highlight: 'DFA + PCA + Clusterização + Predição', color: '#dc2626' },
  { id: 'viz', icon: BarChart3, title: 'Visualização em Power BI', narrative: 'Pipeline de ETL com EventBridge + Glue alimentando Power BI via Athena + Data Gateway, com dashboards interativos para tomada de decisão.', before: 'Relatórios estáticos e desatualizados', after: 'Dashboards Power BI alimentados em tempo real pela AWS', color: '#d97706' },
  { id: 'cicd', icon: GitBranch, title: 'CI/CD e infraestrutura segura', narrative: 'Pipeline CI/CD com Azure DevOps → ECR → ECS, VPN Site-to-Site com Transit Gateway e Landing Zone seguindo melhores práticas AWS.', before: 'Deploys manuais e conectividade insegura com on-premises', after: 'CI/CD automatizado e VPN Site-to-Site com Transit Gateway', color: '#0d9488' },
  { id: 'results', icon: Rocket, title: 'Inteligência industrial em produção', narrative: 'Pipeline completo operacional, equipes capacitadas em 5 áreas com certificação, e documentação técnica de mais de 26 páginas.', before: 'Equipes sem conhecimento em analytics e ML na nuvem', after: 'Equipes certificadas em 5 áreas com pipeline de dados em produção', highlight: '5 áreas de capacitação com certificação', color: '#059669' },
];

export const FIEMGDemo: React.FC = () => {
    ...
    <div className="w-full max-w-4xl mx-auto my-8">
      <div className="relative rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-lg">
        ...
        <div className="relative p-5 md:p-8 space-y-6">
          ...
          {isLast && <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="text-center py-4 rounded-xl bg-emerald-50 border border-emerald-200"><p className="text-sm text-emerald-700 font-medium">Pipeline de Data Analytics e ML transformou a inteligência industrial da FIEMG.</p><p className="text-xs text-slate-500 mt-1">Data Lake, SageMaker e Power BI integrados na AWS.</p></motion.div>}
        </div>
      </div>
    </div>
  );

...
import {
  Factory, Eye, Cloud, Zap, Shield, Users,
...
const steps: JourneyStep[] = [
  {
    id: 'challenge',
    icon: Factory,
    title: 'Indústria têxtil precisa de presença digital',
    narrative: 'A ABIT representa 27,5 mil empresas e 1,5 milhão de trabalhadores. Precisava de transparência nos gastos de TI e agilidade que o provedor anterior não oferecia.',
    before: 'Sem métricas de infraestrutura — limitada a KPIs do Google Analytics',
    after: 'Visibilidade completa de infraestrutura e custos na AWS',
    color: '#2563eb',
  },
  {
    id: 'transparency',
    icon: Eye,
    title: 'Transparência nos gastos de TI',
    narrative: 'Como organização sem fins lucrativos financiada por associados, a ABIT precisa de transparência total nos gastos. O provedor anterior não oferecia essa visibilidade.',
    before: 'Gastos de TI opacos — impossível prestar contas aos associados',
    after: 'Custos transparentes e rastreáveis na AWS para prestação de contas',
  ...
  },
  {
    id: 'agility',
    icon: Zap,
    title: 'Agilidade que faltava',
    narrative: 'No provedor anterior, criar um usuário FTP levava mais de uma semana. A ABIT entrega eventos internacionais e precisa de agilidade para hotsites e marketing.',
    before: 'Mais de uma semana para provisionar um simples usuário FTP',
    after: 'Provisionamento instantâneo de recursos para eventos e campanhas',
    color: '#d97706',
  },
  {
    id: 'migration',
    icon: Cloud,
    title: 'Migração cloud-to-cloud',
    narrative: 'A dataRain migrou a ABIT de outro provedor de nuvem para a AWS, resolvendo pendências do provedor anterior e construindo uma relação de confiança.',
    before: 'Provedor anterior com limitações técnicas e suporte inadequado',
    after: 'Migração completa para AWS com resolução de pendências herdadas',
    color: '#7c3aed',
  },
  {
    id: 'security',
    ...
    narrative: 'Infraestrutura moderna com políticas de segurança adequadas e KPIs transparentes. A ABIT se torna mais confiável para atrair novos associados.',
    before: 'Infraestrutura insegura que não transmitia confiança aos associados',
    after: 'Ambiente seguro e moderno que reflete a solidez da instituição',
    color: '#dc2626',
  },
  {
    id: 'partnership',
    icon: Users,
    title: 'Parceiro de confiança para TI',
    narrative: 'A dataRain se tornou o parceiro de confiança da ABIT para tecnologia e inovação. Estratégia de nuvem de longo prazo com suporte contínuo.',
    before: 'Sem parceiro de confiança para assuntos de TI e inovação',
    after: 'Trusted advisor com estratégia de nuvem de longo prazo',
    color: '#0d9488',
  },
];

export const ABITDemo: React.FC = () => {
      ...
      <div className="relative rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-lg">
        ...
        <div className="relative p-5 md:p-8 space-y-6">
          <div className="flex items-center justify-between">
            <span className="text-sm font-semibold text-slate-700">Jornada da ABIT — Website Institucional na Nuvem AWS</span>
          ...
          {isLast && (
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="text-center py-4 rounded-xl bg-emerald-50 border border-emerald-200">
              <p className="text-sm text-emerald-700 font-medium">A dataRain migrou a ABIT para a AWS com transparência, agilidade e segurança.</p>
              <p className="text-xs text-slate-500 mt-1">Indústria têxtil brasileira com presença digital moderna e confiável.</p>
            </motion.div>
          )}
        </div>
      </div>

...
import { Truck, MapPin, Code2, Shield, Activity, Rocket, ChevronLeft, ChevronRight } from 'lucide-react';
...
const steps: JourneyStep[] = [
  {
    id: 'challenge',
    icon: Truck,
    title: 'Last Mile precisa de escala',
    narrative: 'A Pakman é uma Logtech especializada em Last Mile. Com o crescimento exponencial do e-commerce, precisava de infraestrutura que acompanhasse a demanda de entregas.',
    before: 'Gestão inadequada do tempo de entrega e falta de visibilidade em tempo real',
    after: 'Plataforma escalável para gerenciar entregas com eficiência e rastreamento',
    color: '#d97706',
  },
  {
    id: 'visibility',
    ...
    narrative: 'Antes da AWS, a Pakman não conseguia responder a eventos imprevistos nem otimizar rotas dinamicamente. Clientes exigiam conveniência e agilidade.',
    before: 'Sem visibilidade em tempo real — impossível adaptar rotas ou responder a imprevistos',
    after: 'Rastreamento em tempo real com otimização dinâmica de rotas',
    highlight: 'Entregas rápidas e precisas',
    color: '#2563eb',
  },
  {
    id: 'serverless',
    icon: Code2,
    title: 'Arquitetura serverless robusta',
    narrative: 'Lambda, API Gateway, DynamoDB/RDS, Step Functions, SQS e Fargate. Uma arquitetura distribuída e altamente escalável para logística em grande escala.',
    before: 'Infraestrutura que não acompanhava o crescimento exponencial dos pedidos',
    after: 'Stack serverless completa com escalabilidade automática',
    color: '#7c3aed',
  },
  {
    id: 'security',
    ...
    narrative: 'Security Groups restritivas, VPC Flow Logs, TLS/SSL via ACM, CloudFront com HTTPS e criptografia em RDS e DynamoDB com chaves no KMS.',
    before: 'Controles de segurança básicos para dados sensíveis de entregas',
    after: 'Criptografia ponta a ponta e controles de acesso granulares',
    color: '#dc2626',
  },
  {
    id: 'monitoring',
    ...
    narrative: 'CloudWatch com painel personalizado para infraestrutura, aplicação e erros. IAM com princípio do menor privilégio para todos os desenvolvedores.',
    before: 'Sem visibilidade centralizada sobre a saúde dos sistemas',
    after: 'Monitoramento completo com alertas e métricas em tempo real',
    color: '#0d9488',
  },
  {
    id: 'results',
    icon: Rocket,
    title: 'Logística que escala com o e-commerce',
    narrative: 'Com Serverless Framework e CloudFormation, a Pakman automatizou deploys e ganhou a capacidade de crescer junto com o e-commerce brasileiro.',
    before: 'Crescimento limitado pela capacidade da infraestrutura',
    after: 'Infraestrutura elástica que cresce junto com a demanda do mercado',
    highlight: 'Escalabilidade ilimitada',
    color: '#059669',
  },
];

export const PakmanDemo: React.FC = () => {
      ...
      <div className="relative rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-lg">
        ...
        <div className="relative p-5 md:p-8 space-y-6">
          <div className="flex items-center justify-between">
            <span className="text-sm font-semibold text-slate-700">Jornada da Pakman — Escalabilidade DevOps para Last Mile</span>
          ...
          {isLast && <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="text-center py-4 rounded-xl bg-emerald-50 border border-emerald-200"><p className="text-sm text-emerald-700 font-medium">DevOps na AWS transformou a Pakman em referência de logística escalável.</p><p className="text-xs text-slate-500 mt-1">Entregas rápidas e precisas com arquitetura serverless.</p></motion.div>}
        </div>
      </div>
    </div>
  );

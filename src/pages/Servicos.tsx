        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8">
              Gestão completa de infraestrutura e tecnologia
            </p>
          ...
          <div className="max-w-3xl mx-auto text-center">
            <div className="bg-white rounded-2xl p-12 shadow-lg border border-border/20">
              ...
              <p className="text-muted-foreground">
                Esta página está sendo desenvolvida. Em breve você encontrará aqui todas as informações sobre nossos serviços gerenciados.
              </p>
            </div>
          </div>
        </div>
